...
Binds are a two way link between a Perl and a C++ variable. Changes to the one will be reflected in the other. You can do this using three functions in the magical namespace.
...
Each of them accepts a scalar as first argument and a C++ variable as second argument. You can bind a package variable using the add method of Interpreter.
